...
namespace SPaPS.Controllers
{
    ...
    public class ReferencesController : Controller
    {
        ...
        {
            ViewBag.ReferenceTypeId = new SelectList(_context.ReferenceTypes, "ReferenceTypeId", "ReferenceTypeId");
            return View();
        }
        ...
        public async Task<IActionResult> Create(Reference reference)
        {
            ...
            ViewBag.ReferenceTypeId = new SelectList(_context.ReferenceTypes, "ReferenceTypeId", "ReferenceTypeId", reference.ReferenceTypeId);
            return View(reference);
        }
